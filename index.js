    const temp = document.querySelector('.time');
 	...
 	let typed;
 	let seconds = 60;
    const spark = new Audio("http://k003.kiwi6.com/hotlink/qdpr7bioht/spark.mp3");
 	...
 	function countdown() {
 		const timer = setInterval(() => {
    		...
    		if (seconds === 0) {
                swal(points > 0 ? "Good Job!" : "You can do better!",`Your score is ${points}`);
  	...
  	function random() {
  		words.innerHTML = "";
  		const random = Math.floor(Math.random() * (1944));
